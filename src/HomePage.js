...
const HomePage = () => (
    <div className="Home_page">
        ...
        <div className="container">
            <Section name="Introducing" content={
                `<div>
            ...
            <Section name="HowDo" image={SolutionImg} imagePosition="left" content={
                `<div>
        ...
        <div className="grey_bg">
            <div className="container">
                <Section name="Tokens" image={CRXImg} imageShadow="true" content={
                    `<div>
                        <h1>STREAM Tokens</h1>
        ...
        <div className="container">
            <Section name="Story" image={StoryImg} content={
                `<div>
                    <h1>Our Story</h1>
